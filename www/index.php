...
<table width="975" border="1" align="center" style="background-image:url('slide_image/bkgrnd_greydots.png');">
  <tr>
	...
	slideshowimages("slide_image/food1.png","slide_image/food2.png","slide_image/food3.png","slide_image/food4.png")
...
Come, join!
	...
	if($chk=="registraion")
	{
	var_dump(include_once('regis.php'));
	}
	if($chk=="login")
	{
